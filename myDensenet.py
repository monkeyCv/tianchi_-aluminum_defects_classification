...
def transition_block(x, reduction, name):
    ...
    x = layers.Conv2D(int(backend.int_shape(x)[bn_axis] * reduction), 1,
                      use_bias=False, kernel_regularizer=regularizers.l2(regular_weight),
                      name=name + '_conv')(x)
...
def DenseNet(blocks,
    ...
    x = layers.Conv2D(64, 7, strides=2, use_bias=False, kernel_regularizer=regularizers.l2(regular_weight),name='conv1/conv')(x)
